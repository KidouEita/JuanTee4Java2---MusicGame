  ...
  private class MusicPaneA extends Pane {
    ...
    public MusicPaneA(Scene scene) {
      ...
      animationA.play();
             ...
             switch(e.getCode()) {
                case S: isSPressed = true;System.out.println("Yes"); break; 
                case D: isDPressed = true; break;
                case SPACE: isSpacePressed = true; break;
                case F: isFPressed = true; break;
                case J :isJPressed = true;break;
                case K :isKPressed = true;break;
                case L :isLPressed = true;break;
            }
        });
    }
    ...
    public void Released(Scene scene){
        scene.setOnKeyReleased(e->{
             switch(e.getCode()) {
                ...
                case J :isJPressed = false;break;
                case K :isKPressed = false;break;
                case L :isLPressed = false;break;
            }
        });
    }
